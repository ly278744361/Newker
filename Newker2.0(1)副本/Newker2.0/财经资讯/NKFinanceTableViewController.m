//
//  NKFinanceTableViewController.m
//  Newker2.0
//
...
#define BaseHeadline @"http://c.3g.163.com/nc/article/list/T1348648756099/0-20.html"
#define BasePTDetal @"http://data.live.126.net/liveAll/63943.json"
...
@interface NKFinanceTableViewController ()
...
@implementation NKFinanceTableViewController
...
- (void)viewDidLoad {
    ...
    [self creatquanquan];
    self.navigationItem.title = @"财经资讯";
    [self jsonData];
...
//        case NotReachable:
//            [CheckNetWorking checkNetWoring].status = @"NO";
//            
//            break;
//            
//        case ReachableViaWiFi:
//            [CheckNetWorking checkNetWoring].status = @"WIFI";
//            break;
//            
//        default:
//            [CheckNetWorking checkNetWoring].status = @"YES";
//            break;
//    }
//    
//    
...
//-(void)requestData{
//    
//    if([[CheckNetWorking checkNetWoring].status isEqualToString:@"NO"])
//    {
//        UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"提示" message:@"无网络连接,请检查网络" delegate:nil cancelButtonTitle:nil otherButtonTitles:@"确定", nil];
//        [alert show];
//        _dataArr = [[FMDBHandle shareHandle] selectNewsWithTitle:@"finance"];
//        [self.tableView reloadData];
//        
//    }else
//    {
//        
//        [[RequestHandle alloc] initWithURLString:[kFinanceListURL stringByAppendingString:@"0-20.html"]paraString:nil method:@"GET" delegate:self];
//    }
//}
...
- (void)jsonData
{
    ...
    __block NKFinanceTableViewController *TTVC = self;
    ...
    [NSURLConnection sendAsynchronousRequest:request queue:queue completionHandler:^(NSURLResponse *response, NSData *data, NSError *connectionError) {
        ...
        self.finance = [NSMutableArray array];
        NSArray * array = [dic objectForKey:@"T1348648756099"];
        for (NSDictionary *dic in array){
            Techonlogy *techonlogy = [[Techonlogy alloc] init];
            [techonlogy setValuesForKeysWithDictionary:dic];
            [TTVC.finance addObject:techonlogy];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Techonlogy *techonlogy = [self.finance objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    filePath = [filePath stringByReplacingOccurrencesOfString:@"list/T1348648756099/0-20" withString:docid];
    ...
    if (techonlogy.photosetID&&techonlogy.imgextra) {
        ...
        filePath1 = [filePath1 stringByReplacingOccurrencesOfString:@"63943" withString:[array objectAtIndex:1]];
...
//    视频列表
    ...
    if ([techonlogy.skipType isEqualToString:@"special"]){
        ...
        filePath2 = [filePath2 stringByReplacingOccurrencesOfString:@"article/list/T1348648756099/0-20" withString:special];
