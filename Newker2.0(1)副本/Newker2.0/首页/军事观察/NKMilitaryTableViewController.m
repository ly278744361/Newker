//
//  NKMilitaryTableViewController.m
//  Newker2.0
//
...
#define BaseSport @"http://c.3g.163.com/nc/article/list/T1348648141035/0-20.html"
#define BasePTDetal @"http://c.m.163.com/photo/api/set/0001/91239.json"
#import "Techonlogy.h"
...
@interface NKMilitaryTableViewController ()
...
@implementation NKMilitaryTableViewController
...
- (void)viewDidLoad {
    ...
    [self creatquanquan];
    self.navigationItem.title = @"军事观察";
...
- (void)jsonData
{
    ...
    __block NKMilitaryTableViewController *STVC = self;
    [NSURLConnection sendAsynchronousRequest:request queue:queue completionHandler:^(NSURLResponse *response, NSData *data, NSError *connectionError) {
        ...
        self.military = [NSMutableArray array];
        NSArray *array = [dic objectForKey:@"T1348648141035"];
        for (NSDictionary *dic in array){
            Techonlogy *techonlogy = [[Techonlogy alloc] init];
            [techonlogy setValuesForKeysWithDictionary:dic];
            [STVC.military addObject:techonlogy];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Techonlogy *techonlogy = [self.military objectAtIndex:indexPath.row];
    ...
    filePath = [filePath stringByReplacingOccurrencesOfString:@"list/T1348648141035/0-20" withString:docid];
    ...
    if (techonlogy.photosetID&&techonlogy.imgextra) {
        ...
        filePath1 = [filePath1 stringByReplacingOccurrencesOfString:@"91239" withString:[array objectAtIndex:1]];
    ...
    if ([techonlogy.skipType isEqualToString:@"special"]){
        ...
        filePath2 = [filePath2 stringByReplacingOccurrencesOfString:@"article/list/T1348648141035/0-20" withString:special];
