...
#define BaseNews @"http://c.3g.163.com/nc/article/list/T1429173683626/0-20.html"
#define BasePTDetal @"http://c.3g.163.com/photo/api/set/0001/90938.json"

@interface NKNewsbreakViewController ()
...
@implementation NKNewsbreakViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    filePath = [filePath stringByReplacingOccurrencesOfString:@"list/T1429173683626/0-20" withString:docid];
    ...
    if (techonlogy.photosetID&&techonlogy.imgextra) {
        ...
        filePath1 = [filePath1 stringByReplacingOccurrencesOfString:@"90938" withString:[array objectAtIndex:1]];
    ...
    if ([techonlogy.skipType isEqualToString:@"special"]){
        ...
        filePath1 = [filePath1 stringByReplacingOccurrencesOfString:@"article/list/T1429173683626/0-20" withString:special];
...
- (void)jsonData
{
    ...
    __block NKNewsbreakViewController *FTVC = self;
    [NSURLConnection sendAsynchronousRequest:request queue:queue completionHandler:^(NSURLResponse *response, NSData *data, NSError *connectionError) {
        ...
        NSArray *array = [dic objectForKey:@"T1429173683626"];
