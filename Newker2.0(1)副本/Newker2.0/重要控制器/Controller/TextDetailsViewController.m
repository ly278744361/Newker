...
- (void)createView
{
    ...
    self.ptimeLabel = [[UILabel alloc] initWithFrame:CGRectMake(100, 40, [UIScreen mainScreen].bounds.size.width - 140, 20)];
    _ptimeLabel.font = [UIFont boldSystemFontOfSize:12.f];
    _ptimeLabel.alpha = 0.5;
    
    self.contactLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 25,[UIScreen mainScreen].bounds.size.width-20, 1500)];
    NSLog(@"text");
