...
- (void)createView
{
    ...
    self.titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 10, [UIScreen mainScreen].bounds.size.width-40, 30)];
    self.sourceLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 40, 120, 20)];
    ...
    self.contactLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, ([_details.video count]*250+ 30)+[_details.img count]*280+40, [UIScreen mainScreen].bounds.size.width-20, 1000)];
    
    for (int i = 0; i<[self.details.video count]; i++) {
        
        NSLog(@"Video!!!");
        
        UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(10, i*200+60, [UIScreen mainScreen].bounds.size.width-20, 200)];
        ...
        UILabel *altLabel = [[UILabel alloc] initWithFrame:CGRectMake(imageView.frame.origin.x, imageView.frame.origin.y+imageView.frame.size.height + 10, imageView.frame.size.width, 20)];
    ...
    for (int i = 0; i<[_details.img count]; i++) {
        ...
        UIImageView *image = [[UIImageView alloc] initWithFrame:CGRectMake(10, ([_details.video count]*250+60)+i*280+30,[UIScreen mainScreen].bounds.size.width - 20 , 280)];
