//
//  NKOpenClassTableViewController.m
//  Newker2.0
//
...
#define BaseSport @"http://c.3g.163.com/nc/article/list/T1348654204705/0-20.html"
#define BasePTDetal @"http://c.3g.163.com/photo/api/set/0006/83674.json"
#import "Techonlogy.h"
...
@interface NKOpenClassTableViewController ()
...
@implementation NKOpenClassTableViewController
...
- (void)viewDidLoad {
    ...
    [self creatquanquan];
    self.navigationItem.title = @"旅游在线";
...
- (void)jsonData
{
    ...
    __block NKOpenClassTableViewController *STVC = self;
    [NSURLConnection sendAsynchronousRequest:request queue:queue completionHandler:^(NSURLResponse *response, NSData *data, NSError *connectionError) {
        ...
        self.openClass = [NSMutableArray array];
        NSArray *array = [dic objectForKey:@"T1348654204705"];
        for (NSDictionary *dic in array){
            Techonlogy *techonlogy = [[Techonlogy alloc] init];
            [techonlogy setValuesForKeysWithDictionary:dic];
            [STVC.openClass addObject:techonlogy];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Techonlogy *techonlogy = [self.openClass objectAtIndex:indexPath.row];
    ...
    filePath = [filePath stringByReplacingOccurrencesOfString:@"list/T1348654204705/0-20" withString:docid];
    ...
    if (techonlogy.photosetID&&techonlogy.imgextra) {
        ...
        filePath1 = [filePath1 stringByReplacingOccurrencesOfString:@"83674" withString:[array objectAtIndex:1]];
    ...
    if ([techonlogy.skipType isEqualToString:@"special"]){
        ...
        filePath2 = [filePath2 stringByReplacingOccurrencesOfString:@"article/list/T1348654204705/0-20" withString:special];
