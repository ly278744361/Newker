...
- (void)createView
{
    self.titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, 10, [UIScreen mainScreen].bounds.size.width - 20, 30)];
    _titleLabel.font = [UIFont boldSystemFontOfSize:20.0f];
    
    self.sourceLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, 40, 100, 20)];
    ...
    self.altLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, 250,[UIScreen mainScreen].bounds.size.width - 40, 20)];
    _altLabel.font = [UIFont systemFontOfSize:12.f];
    _altLabel.alpha = 0.5;
    
    self.headerImage = [[UIImageView alloc] initWithFrame:CGRectMake(20, 65, [UIScreen mainScreen].bounds.size.width - 40, [UIScreen mainScreen].bounds.size.width * 5 /10)];
    
    self.contactLabel = [[UILabel alloc] initWithFrame:CGRectMake(20,_headerImage.frame.size.height + 50.0, [UIScreen mainScreen].bounds.size.width-40, 1200)];
