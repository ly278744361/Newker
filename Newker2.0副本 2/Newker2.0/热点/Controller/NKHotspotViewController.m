...
#define BaseNews @"http://c.3g.163.com/nc/article/list/T1414142214384/0-20.html"
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    filePath = [filePath stringByReplacingOccurrencesOfString:@"list/T1414142214384/0-20" withString:docid];
    ...
    if ([techonlogy.skipType isEqualToString:@"special"]){
        ...
        filePath1 = [filePath1 stringByReplacingOccurrencesOfString:@"article/list/T1414142214384/0-20" withString:special];
...
- (void)jsonData
{
    ...
    __block NKHotspotViewController *FTVC = self;
    [NSURLConnection sendAsynchronousRequest:request queue:queue completionHandler:^(NSURLResponse *response, NSData *data, NSError *connectionError) {
        ...
        NSArray *array = [dic objectForKey:@"T1414142214384"];
