//
//  NKPhysicalTableViewController.m
//  Newker2.0
//
...
#define BaseSport @"http://c.3g.163.com/nc/article/list/T1348649079062/0-20.html"
#define BasePTDetal @"http://c.3g.163.com/photo/api/set/0096/52192.json"
#import "Techonlogy.h"
...
@interface NKPhysicalTableViewController ()
...
@implementation NKPhysicalTableViewController
...
- (void)viewDidLoad {
    ...
    [self creatquanquan];
    self.navigationController.title = @"体育赛事";
...
- (void)jsonData
{
    ...
    __block NKPhysicalTableViewController *STVC = self;
    [NSURLConnection sendAsynchronousRequest:request queue:queue completionHandler:^(NSURLResponse *response, NSData *data, NSError *connectionError) {
        ...
        self.physical = [NSMutableArray array];
        NSArray *array = [dic objectForKey:@"T1348649079062"];
        for (NSDictionary *dic in array){
            Techonlogy *techonlogy = [[Techonlogy alloc] init];
            [techonlogy setValuesForKeysWithDictionary:dic];
            [STVC.physical addObject:techonlogy];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Techonlogy *techonlogy = [self.physical objectAtIndex:indexPath.row];
    ...
    filePath = [filePath stringByReplacingOccurrencesOfString:@"list/T1348649079062/0-20" withString:docid];
    ...
    if (techonlogy.photosetID&&techonlogy.imgextra) {
        ...
        filePath1 = [filePath1 stringByReplacingOccurrencesOfString:@"52192" withString:[array objectAtIndex:1]];
    ...
    if ([techonlogy.skipType isEqualToString:@"special"]){
        ...
        filePath2 = [filePath2 stringByReplacingOccurrencesOfString:@"article/list/T1348649079062/0-20" withString:special];
