...
// RGB颜色
#define NKColor(r, g, b) [UIColor colorWithRed:(r)/255.0 green:(g)/255.0 blue:(b)/255.0 alpha:1.0]

// 随机色
#define NKRandomColor NKColor(arc4random_uniform(256), arc4random_uniform(256), arc4random_uniform(256))
...
- (void)viewDidLoad {
    ...
    weatherTVC.view.frame = CGRectMake(0, 150, self.view.bounds.size.width, self.view.bounds.size.height - 150);
