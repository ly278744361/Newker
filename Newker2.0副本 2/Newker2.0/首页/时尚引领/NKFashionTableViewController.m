//
//  NKFashionTableViewController.m
//  Newker2.0
//
...
#define BaseFashion @"http://c.3g.163.com/nc/article/list/T1348650593803/0-20.html"
#define BasePT @"http://c.3g.163.com/photo/api/set/0026/76607.json"
#import "Techonlogy.h"
...
@interface NKFashionTableViewController ()
...
@implementation NKFashionTableViewController
...
- (void)viewDidLoad {
    ...
    [self creatquanquan];
    self.navigationController.title = @"时尚引领";
    [self jsonData];
...
- (void)jsonData
{
    ...
    NSURL *url = [NSURL URLWithString:[BaseFashion stringByReplacingOccurrencesOfString:@"-20" withString:pn]];
    NSURLRequest *request = [NSURLRequest requestWithURL:url cachePolicy:NSURLRequestUseProtocolCachePolicy timeoutInterval:20];
    __block NKFashionTableViewController *FTVC = self;
    ...
    [NSURLConnection sendAsynchronousRequest:request queue:queue completionHandler:^(NSURLResponse *response, NSData *data, NSError *connectionError) {
        ...
        self.fashion = [NSMutableArray array];
        NSArray *array = [dic objectForKey:@"T1348650593803"];
        for (NSDictionary *dic in array){
            Techonlogy *techonlogy = [[Techonlogy alloc] init];
            [techonlogy setValuesForKeysWithDictionary:dic];
            [FTVC.fashion addObject:techonlogy];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Techonlogy *techonlogy = [self.fashion objectAtIndex:indexPath.row];
    NSString *filePath = BaseFashion;
    NSString *filePath2 = BasePT;
    
    NSString *docid = [techonlogy.docid stringByAppendingString:@"/full"];
    filePath = [filePath stringByReplacingOccurrencesOfString:@"list/T1348650593803/0-20" withString:docid];
    ...
    if (techonlogy.photosetID&&techonlogy.imgextra) {
        ...
        filePath2 = [filePath2 stringByReplacingOccurrencesOfString:@"76607" withString:[array objectAtIndex:1]];
    ...
    if ([techonlogy.skipType isEqualToString:@"special"]){
        ...
        filePath = [filePath stringByReplacingOccurrencesOfString:@"article/list/T1348650593803/0-20" withString:special];
